...
const Login = ({ setShowLogin, setShowRegister, setUser }) => {
  ...
  return (
    <div className="auth-overlay" onClick={(e) => e.target.classList.contains("auth-overlay") && setShowLogin(false)}>
      <div className={`auth-modal${shake ? " auth-modal--shake" : ""}`}>

        {/* ── LEFT BRAND PANEL ── */}
        <div className="auth-brand">
          <button className="auth-close auth-close--brand" onClick={() => setShowLogin(false)}>✕</button>
          ...
          <h2 className="auth-brand__heading">India's fastest<br/>grocery delivery</h2>
          <p className="auth-brand__sub">Fresh products delivered to your door in minutes.</p>
            ...
            <form onSubmit={handleLogin} noValidate>
              ...
              <button type="submit" className="auth-submit-btn" disabled={loading}>
                {loading
                  ...
                  : <><span>Sign In</span><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M5 12h14M12 5l7 7-7 7"/></svg></>
                }
              </button>
            </form>
